...
- [x] **HIGH-04**: Custom lexer support for domain-specific languages (MLIR via Pygments RegexLexer)
...
**Adjusted:** HIGH-04 description changed from "Sublime syntax" to "Pygments RegexLexer" during implementation (simpler approach, same outcome)
**Dropped:** None
